"""
-------------------------------------------------------------------
  FILE NAME: Function_Library.py (Simplified Version)
  Copyright: Sungkyunkwan University, Automation Lab.
-------------------------------------------------------------------
  This file contains only the necessary functions for main.py
-------------------------------------------------------------------
"""
...
class libCAMERA(object):
    ...
    def initial_setting(self, cam0port=0, cam1port=3, capnum=1):
...
#         return result
#
#     def edge_detection(self, img, width=0, height=0, gap=0, threshold=0, print_enable=True):
#         prediction = None
#         replica = img.copy()
#         self.row, self.col, self.dim = img.shape
#
